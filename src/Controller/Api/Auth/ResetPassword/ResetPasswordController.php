...
use App\Form\Auth\ResetPassword\ResetPasswordRequestForm;
...
//            $user->setPassword($passwordHasher->hashPassword($user, $plainPassword));
            /** @see \App\Listeners\EntityListener\UserEntityListener::preUpdate() Hash will in that class */
...
//            }
            ...
            return $this->redirectToRoute('view_auth_login_form');//TODO burası değişecek.
        }
