...
class ResetPasswordController extends AbstractController
{
    ...
    #[OA\RequestBody(
        ...
        content: new OA\JsonContent(
            ref: new Model(type: ResetPasswordRequestForm::class),
            example: [
                'email' => "emre.vural@kodpit.com"
            ]
        )
    )]
    ...
    public function request(Request $request, MailerInterface $mailer, TranslatorInterface $translator): Response
    {
        ...
        return $this->json(array("hata" =>1),404);
    }
     ...
     */
    #[Route('/reset/{token}', name: 'api_reset_password', methods: ["GET", "POST"])]
    public function reset(Request $request,  TranslatorInterface $translator, ?string $token = null): Response
    {
        ...
        try {
            ...
            return $this->redirectToRoute('api_forgot_password_request');
        }
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        if (!$user) {
            return $this->redirectToRoute('api_check_email');
        }
        ...
        $resetUrl = $this->generateUrl("api_reset_password",["token" => $resetToken->getToken()], UrlGeneratorInterface::ABSOLUTE_URL);
