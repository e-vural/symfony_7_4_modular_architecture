...
#[AllowDynamicProperties] class CustomAuthenticator extends JWTAuthenticator
{
...
//        dd($this->getUserProvider()->loadUserByIdentifier("email"));
    ...
    public function createToken(Passport $passport, string $firewallName): TokenInterface
    {
        ...
        $token = new CustomAuthenticationToken($passport->getUser(), $firewallName, $passport->getUser()->getRoles(), $passport->getAttribute('token'));
        return $token;
    }
}
